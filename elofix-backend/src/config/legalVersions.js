...
const LEGAL_VERSIONS = {
  ...
  providerAgreement: process.env.LEGAL_PROVIDER_AGREEMENT_VERSION || "2026-06-24",
  refundPolicy: process.env.LEGAL_REFUND_POLICY_VERSION || "2026-06-24",
  jobCompletionVerification: process.env.LEGAL_JOB_COMPLETION_VERSION || "2026-06-24",
  escrowPolicy: process.env.LEGAL_ESCROW_POLICY_VERSION || "2026-06-24",
  disputeResolution: process.env.LEGAL_DISPUTE_RESOLUTION_VERSION || "2026-06-24",
