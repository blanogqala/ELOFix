...
const LEGAL_VERSIONS = {
  terms: process.env.LEGAL_TERMS_VERSION || "2026-09-14",
  privacy: process.env.LEGAL_PRIVACY_VERSION || "2026-09-14",
  providerAgreement: process.env.LEGAL_PROVIDER_AGREEMENT_VERSION || "2026-09-14",
  refundPolicy: process.env.LEGAL_REFUND_POLICY_VERSION || "2026-09-14",
  jobCompletionVerification: process.env.LEGAL_JOB_COMPLETION_VERSION || "2026-08-18",
  escrowPolicy: process.env.LEGAL_ESCROW_POLICY_VERSION || "2026-09-14",
  disputeResolution: process.env.LEGAL_DISPUTE_RESOLUTION_VERSION || "2026-09-14",
  ...
  providerVerification: process.env.LEGAL_PROVIDER_VERIFICATION_VERSION || "2026-09-14",
  ...
  supplierAgreement: process.env.LEGAL_SUPPLIER_AGREEMENT_VERSION || "2026-09-14",
  supplierParticipation: process.env.LEGAL_SUPPLIER_PARTICIPATION_VERSION || "2026-08-18",
  dataProcessing: process.env.LEGAL_DATA_PROCESSING_VERSION || "2026-09-14",
  ...
  deliveryPolicy: process.env.LEGAL_DELIVERY_POLICY_VERSION || "2026-09-14",
};
