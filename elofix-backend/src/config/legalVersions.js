...
const LEGAL_VERSIONS = {
  terms: process.env.LEGAL_TERMS_VERSION || "2026-08-18",
  privacy: process.env.LEGAL_PRIVACY_VERSION || "2026-08-18",
  providerAgreement: process.env.LEGAL_PROVIDER_AGREEMENT_VERSION || "2026-08-18",
  refundPolicy: process.env.LEGAL_REFUND_POLICY_VERSION || "2026-08-18",
  jobCompletionVerification: process.env.LEGAL_JOB_COMPLETION_VERSION || "2026-08-18",
  escrowPolicy: process.env.LEGAL_ESCROW_POLICY_VERSION || "2026-08-18",
  disputeResolution: process.env.LEGAL_DISPUTE_RESOLUTION_VERSION || "2026-08-18",
  adminInvestigation: process.env.LEGAL_ADMIN_INVESTIGATION_VERSION || "2026-08-18",
  ...
  deliveryPolicy: process.env.LEGAL_DELIVERY_POLICY_VERSION || "2026-08-18",
};
