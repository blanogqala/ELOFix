            ...
            <div className="landing-float relative z-10 grid max-w-sm grid-cols-2 gap-4 p-8">
              ...
              {['Orders', 'Branches', 'Inventory', 'Earnings'].map((label, i) => (
                ...
                <div
                  ...
                  className="rounded-2xl border-accent border-2 border-accent/50 bg-accent/30 p-5 backdrop-blur-sm"

                  style={{ animationDelay: `${i * 200}ms` }}

                >

                  <div className="mb-2 text-2xl font-bold text-accent drop-shadow-sm">
