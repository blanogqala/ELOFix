...
export function FinalCTASection() {
  ...
  return (
    <LandingSection reveal={false} className="pb-0 pt-8 md:pt-12 bg-accent/20 backdrop-blur-sm">
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-[hsl(213,75%,18%)] to-[hsl(213,65%,28%)] px-6 py-14 text-center text-primary-foreground shadow-2xl md:px-12 md:py-20">
        <div className="landing-hero-grid absolute inset-0 opacity-[0.06]" aria-hidden />
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="h-12 w-full border-white/25 bg-white/10 text-white hover:bg-white/20 hover:text-white"
