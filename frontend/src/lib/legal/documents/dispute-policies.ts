  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        'Completion dispute: the Customer may reject Provider completion while the Job is in Awaiting Confirmation during the 7-day verification window. That path uses the current completion-dispute process.',
        'Cancellation dispute: a cancellation request may open an administrator dispute or review from other eligible Job statuses. Cancellation disputes are not limited to Awaiting Confirmation.',
        'This policy does not claim that all disputes can only be opened during Awaiting Confirmation.',
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        'Review payment activity, payment-schedule status, customer payment obligations, refunds, provider repayment, overdue debt, and chargebacks.',
